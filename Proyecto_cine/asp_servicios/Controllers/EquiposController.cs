...
namespace asp_servicios.Controllers
{
    ...
    {
        private IEquiposAplicacion? iAplicacion = null;
        private TokenAplicacion? iAplicacionToken = null;

        public EquiposController(IEquiposAplicacion? iAplicacion, TokenAplicacion iAplicacionToken)
        {
        ...
        public string PorMarca()
        {
            ...
            try
            {
                ...
                respuesta["Entidades"] = this.iAplicacion!.PorMarca(entidad);
                respuesta["Respuesta"] = "OK";
                respuesta["Fecha"] = DateTime.Now.ToString();
                return JsonConversor.ConvertirAString(respuesta);
            }
