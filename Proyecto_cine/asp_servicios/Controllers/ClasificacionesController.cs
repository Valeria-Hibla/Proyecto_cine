...
namespace asp_servicios.Controllers
{
    ...
    {
        private IClasificacionesAplicacion? iAplicacion = null;
        private TokenAplicacion? iAplicacionToken = null;

        public ClasificacionesController(IClasificacionesAplicacion? iAplicacion, TokenAplicacion iAplicacionToken)
        {
